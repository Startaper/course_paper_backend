...
public class ApplicantEntity {
    ...
    @OneToMany(mappedBy = "applicant", cascade = CascadeType.ALL)
    private List<AreaEntity> citizenship;
    @OneToMany(mappedBy = "applicant", cascade = CascadeType.ALL)
    private List<AreaEntity> workTickets;
    @OneToMany(mappedBy = "applicant", cascade = CascadeType.ALL)
    ...
    public ApplicantEntity(JSONObject jsonObject, SimpleDateFormat dateFormat) throws JSONException, ParseException {
        ...
        this.educationLevel = EducationLevel.valueOf(jsonObject.getJSONObject("education").getJSONObject("level").getString("id"));
        this.photoUrl = jsonObject.getJSONObject("photo").getString("medium");
